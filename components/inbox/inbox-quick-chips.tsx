...
import { CalendarClock, Inbox, SquarePen } from "lucide-react";
    ...
    <section className="grid grid-cols-3 gap-2">
      ...
      >
        <span className="inline-flex items-center gap-1.5">
          <Inbox className="h-[18px] w-[18px] shrink-0 text-[#2563EB]" strokeWidth={2} aria-hidden />
          <span className="whitespace-nowrap">Unread</span>
        </span>
