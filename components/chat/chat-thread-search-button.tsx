...
const searchIconBtnClass = cn(
  ...
  "border border-border/70 bg-background/95 text-muted-foreground shadow-sm transition-all duration-200",
  "hover:border-border hover:bg-muted/60 hover:text-foreground active:scale-95",
