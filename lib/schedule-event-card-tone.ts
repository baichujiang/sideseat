...
export const SCHEDULE_EVENT_TONE_STYLES: Record<ScheduleEventToneKey, ToneStyle> = {
  ...
  draftNew: {
    card: "rounded-[2px] border border-dashed border-[#93C5FD] bg-[#EFF6FF]/60 dark:border-blue-400/50 dark:bg-blue-950/25",
    cardSelected:
      "rounded-[2px] border-2 border-dashed border-[#2563EB] bg-[#EFF6FF]/85 shadow-[0_2px_10px_rgba(37,99,235,0.14)] dark:border-blue-400 dark:bg-blue-950/40",
  ...
  study: {
    card: "rounded-[2px] border border-[#BFDBFE] bg-[#EFF6FF] shadow-[0_2px_8px_rgba(37,99,235,0.10)] dark:border-blue-500/40 dark:bg-blue-950/35",
    cardSelected:
      "rounded-[2px] border border-[#1D4ED8] bg-[#1D4ED8] shadow-[0_4px_12px_rgba(37,99,235,0.22)] dark:border-blue-400 dark:bg-blue-400",
    accentColor: "text-[#2563EB] dark:text-blue-300",
  ...
  meal: {
    card: "rounded-[2px] border border-[#FED7AA] bg-[#FFF7ED] shadow-[0_2px_8px_rgba(234,88,12,0.08)] dark:border-orange-500/35 dark:bg-orange-950/30",
    cardSelected:
      "rounded-[2px] border border-[#C2410C] bg-[#C2410C] shadow-[0_4px_12px_rgba(234,88,12,0.2)] dark:border-orange-400 dark:bg-orange-400",
  ...
  sports: {
    card: "rounded-[2px] border border-[#BBF7D0] bg-[#F0FDF4] shadow-[0_2px_8px_rgba(22,163,74,0.08)] dark:border-emerald-500/35 dark:bg-emerald-950/30",
    cardSelected:
      "rounded-[2px] border border-[#15803D] bg-[#15803D] shadow-[0_4px_12px_rgba(22,163,74,0.2)] dark:border-emerald-400 dark:bg-emerald-400",
  ...
  language: {
    card: "rounded-[2px] border border-[#99F6E4] bg-[#F0FDFA] shadow-[0_2px_8px_rgba(15,118,110,0.08)] dark:border-teal-500/35 dark:bg-teal-950/30",
    cardSelected:
      "rounded-[2px] border border-[#0D9488] bg-[#0D9488] shadow-[0_4px_12px_rgba(15,118,110,0.2)] dark:border-teal-400 dark:bg-teal-400",
  ...
  personal: {
    card: "rounded-[2px] border border-[#E5E7EB] bg-[#F3F4F6] shadow-[0_2px_8px_rgba(107,114,128,0.08)] dark:border-zinc-600 dark:bg-zinc-900/50",
    cardSelected:
      "rounded-[2px] border border-[#4B5563] bg-[#4B5563] shadow-[0_4px_12px_rgba(75,85,99,0.2)] dark:border-zinc-500 dark:bg-zinc-500",
  ...
  planPending: {
    card: "rounded-[2px] border border-[#FDE68A] bg-[#FEF3C7] shadow-[0_2px_8px_rgba(217,119,6,0.1)] dark:border-amber-500/35 dark:bg-amber-950/30",
    cardSelected:
      "rounded-[2px] border border-[#B45309] bg-[#B45309] shadow-[0_4px_12px_rgba(217,119,6,0.22)] dark:border-amber-400 dark:bg-amber-400",
  ...
  available: {
    card: "rounded-[2px] border border-[#5EEAD4] bg-[#ECFEFF] shadow-[0_2px_8px_rgba(13,148,136,0.1)] dark:border-cyan-500/35 dark:bg-cyan-950/30",
    cardSelected:
      "rounded-[2px] border border-[#0F766E] bg-[#0F766E] shadow-[0_4px_12px_rgba(13,148,136,0.22)] dark:border-cyan-400 dark:bg-cyan-400",
  ...
  pendingRequest: {
    card: "rounded-[2px] border border-[#FDE68A] bg-[#FEF3C7] shadow-[0_2px_8px_rgba(217,119,6,0.1)] dark:border-amber-500/35 dark:bg-amber-950/30",
    cardSelected:
      "rounded-[2px] border border-[#A16207] bg-[#A16207] shadow-[0_4px_12px_rgba(202,138,4,0.22)] dark:border-amber-400 dark:bg-amber-400",
  ...
  busy: {
    card: "rounded-[2px] border border-[#D1D5DB] bg-[#F3F4F6] shadow-[0_2px_8px_rgba(75,85,99,0.06)] dark:border-zinc-600 dark:bg-zinc-900/55",
    cardSelected:
      "rounded-[2px] border border-[#4B5563] bg-[#4B5563] shadow-[0_4px_12px_rgba(55,65,81,0.2)] dark:border-zinc-500 dark:bg-zinc-500",
    accentColor: "text-[#6B7280] dark:text-zinc-400",
    accentColorSelected: "text-white/90",
    title: "truncate font-semibold text-[#111827] dark:text-foreground",
    titleSelected: "truncate font-semibold text-white",
  ...
  declined: {
    card: "rounded-[2px] border border-[#FECACA] bg-[#FEF2F2] shadow-[0_2px_8px_rgba(220,38,38,0.08)] dark:border-red-500/35 dark:bg-red-950/30",
    cardSelected:
      "rounded-[2px] border border-[#B91C1C] bg-[#B91C1C] shadow-[0_4px_12px_rgba(220,38,38,0.2)] dark:border-red-400 dark:bg-red-400",
  ...
  course: {
    card: "rounded-[2px] border border-[#E5E7EB] bg-[#F9FAFB] shadow-[0_2px_8px_rgba(71,85,105,0.07)] dark:border-slate-600 dark:bg-slate-900/45",
    cardSelected:
      "rounded-[2px] border border-[#334155] bg-[#334155] shadow-[0_4px_12px_rgba(51,65,85,0.2)] dark:border-slate-400 dark:bg-slate-400",
