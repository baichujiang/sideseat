...
export const SCHEDULE_EVENT_TONE_STYLES: Record<ScheduleEventToneKey, ToneStyle> = {
  ...
  draftNew: {
    card: "rounded-2xl border border-dashed border-[#93C5FD] bg-[#EFF6FF]/60 dark:border-blue-400/50 dark:bg-blue-950/25",
    cardSelected:
      "rounded-2xl border-2 border-dashed border-[#2563EB] bg-[#EFF6FF]/85 shadow-[0_2px_10px_rgba(37,99,235,0.14)] dark:border-blue-400 dark:bg-blue-950/40",
  ...
  meal: {
    ...
    cardSelected:
      "rounded-2xl border border-[#EA580C] bg-[#EA580C] shadow-[0_4px_12px_rgba(234,88,12,0.2)] dark:bg-orange-600",
  ...
  sports: {
    ...
    cardSelected:
      "rounded-2xl border border-[#16A34A] bg-[#16A34A] shadow-[0_4px_12px_rgba(22,163,74,0.2)] dark:bg-emerald-600",
  ...
  language: {
    ...
    cardSelected:
      "rounded-2xl border border-[#0F766E] bg-[#0F766E] shadow-[0_4px_12px_rgba(15,118,110,0.2)] dark:bg-teal-600",
  ...
  personal: {
    ...
    cardSelected:
      "rounded-2xl border border-[#6B7280] bg-[#6B7280] shadow-[0_4px_12px_rgba(75,85,99,0.2)] dark:bg-zinc-600",
  ...
  planPending: {
    ...
    cardSelected:
      "rounded-2xl border border-[#D97706] bg-[#D97706] shadow-[0_4px_12px_rgba(217,119,6,0.22)] dark:bg-amber-600",
  ...
  available: {
    card: "rounded-2xl border border-[#5EEAD4] bg-[#ECFEFF] shadow-[0_2px_8px_rgba(13,148,136,0.1)] dark:border-cyan-500/35 dark:bg-cyan-950/30",
    cardSelected:
      "rounded-2xl border border-[#0D9488] bg-[#14B8A6] shadow-[0_4px_12px_rgba(13,148,136,0.22)] dark:bg-teal-600",
  ...
  pendingRequest: {
    card: "rounded-2xl border border-[#FDE68A] bg-[#FEF3C7] shadow-[0_2px_8px_rgba(217,119,6,0.1)] dark:border-amber-500/35 dark:bg-amber-950/30",
    cardSelected:
      "rounded-2xl border border-[#CA8A04] bg-[#CA8A04] shadow-[0_4px_12px_rgba(202,138,4,0.22)] dark:bg-amber-600",
  ...
  busy: {
    card: "rounded-2xl border border-[#D1D5DB] bg-[#F3F4F6] shadow-[0_2px_8px_rgba(75,85,99,0.06)] dark:border-zinc-600 dark:bg-zinc-900/55",
    cardSelected:
      "rounded-2xl border border-[#4B5563] bg-[#4B5563] shadow-[0_4px_12px_rgba(55,65,81,0.2)] dark:bg-zinc-600",
    accentColor: "text-[#6B7280] dark:text-zinc-400",
    accentColorSelected: "text-white/90",
    title: "truncate font-semibold text-[#111827] dark:text-foreground",
    titleSelected: "truncate font-semibold text-white",
  ...
  declined: {
    card: "rounded-2xl border border-[#FECACA] bg-[#FEF2F2] shadow-[0_2px_8px_rgba(220,38,38,0.08)] dark:border-red-500/35 dark:bg-red-950/30",
    cardSelected:
      "rounded-2xl border border-[#DC2626] bg-[#DC2626] shadow-[0_4px_12px_rgba(220,38,38,0.2)] dark:bg-red-600",
  ...
  course: {
    card: "rounded-2xl border border-[#E5E7EB] bg-[#F9FAFB] shadow-[0_2px_8px_rgba(71,85,105,0.07)] dark:border-slate-600 dark:bg-slate-900/45",
    cardSelected:
      "rounded-2xl border border-[#475569] bg-[#475569] shadow-[0_4px_12px_rgba(51,65,85,0.2)] dark:bg-slate-600",
