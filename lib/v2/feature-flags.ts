...
const ENV_BY_FEATURE: Record<V2FeatureKey, string> = {
  ...
  v2ActivityFit: "V2_ACTIVITY_FIT_ENABLED",
  v2FlexibleTiming: "V2_FLEXIBLE_TIMING_ENABLED",
  v2AutomaticMatching: "V2_AUTOMATIC_MATCHING_ENABLED",
  v2DiscoveryMatching: "V2_DISCOVERY_MATCHING_ENABLED",
  v2ExploreIntents: "V2_EXPLORE_INTENTS_ENABLED",
  v2MeetAgain: "V2_MEET_AGAIN_ENABLED",
