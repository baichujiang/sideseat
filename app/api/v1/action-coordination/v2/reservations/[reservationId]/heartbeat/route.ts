...
import {
  heartbeatCreatorGatedActionCoordinationReservation,
...
export async function POST(
  ...
  try {
    return mutationResponse(
      await heartbeatCreatorGatedActionCoordinationReservation({
    ...
    return v1Error(request, {
      code: "INTERNAL_ERROR",
      message: "The coordination shell heartbeat could not be applied.",
      status: 500,
      retryable: true,
    });
  }
